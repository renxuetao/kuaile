...
import com.klzb.live.XieyiActivity;
import com.klzb.live.base.BaseEditActivity;
import com.klzb.live.event.BroadCastEvent;
...
public class LoginActivity extends BaseEditActivity implements OnLoginResultListener {
...
//    }
    ...
    public void openXieyi(){
        ...
        temp.putString("title","协议内容");
        temp.putString("jump",Api.XIEYI);
