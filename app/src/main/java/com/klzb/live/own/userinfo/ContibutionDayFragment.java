 ...
 * Author: XuDeLong
 */
public class ContibutionDayFragment extends BaseFragment implements OnRecyclerViewItemClickListener {
    ...
    public static ContibutionDayFragment getInstance(int pos) {
        ContibutionDayFragment fragment = new ContibutionDayFragment();
