 ...
 * Author: XuDeLong
 */
public class ContibutionWeekFragment extends BaseFragment implements OnRecyclerViewItemClickListener {
    ...
    public static ContibutionWeekFragment getInstance(int pos) {
        ContibutionWeekFragment fragment = new ContibutionWeekFragment();
