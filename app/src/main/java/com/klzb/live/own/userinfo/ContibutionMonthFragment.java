 ...
 * Author: XuDeLong
 */
public class ContibutionMonthFragment extends BaseFragment implements OnRecyclerViewItemClickListener {
    ...
    public static ContibutionMonthFragment getInstance(int pos) {
        ContibutionMonthFragment fragment = new ContibutionMonthFragment();
