...
import com.klzb.live.own.follow.FollowItem;
import com.klzb.live.own.follow.FollowListAdapterother;
        ...
        if (!StringUtils.isEmpty(token) && !StringUtils.isEmpty(userId)) {
            ...
            Api.getUserInfo(this, requestParams, new OnRequestDataListener() {
                ...
                public void requestSuccess(int code, JSONObject data) {
                    ...
                    if ("2".equals(userInfo.getString("channel_status"))) {
                        ...
                        mBtnLiveStatus.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                temp.setMinute_charge(userInfo.getString("minute_charge"));
                                temp.setPrice(userInfo.getString("price"));
                                temp.setNeed_password(userInfo.getString("need_password"));
                                liveStatusClick(temp);
                    ...
                    FunctionUtile.setLevel(UserMainActivity.this,mTextUserLevel,level);
//                    if(level<5){
...
//            });
    ...
    public void liveStatusClick(final VideoItem item) {
        if(StringUtils.isNotEmpty(item.getPrice()) && Integer.parseInt(item.getPrice())>0){
            DialogEnsureUtiles.showConfirm(this, "该房间需要收费" + item.getPrice(), new OnCustomClickListener() {
                @Override
            ...
            DialogEnsureUtiles.showInfo(this, new OnCustomClickListener() {
                @Override
                public void onClick(final String value) {
                    JSONObject params = new JSONObject();
                    params.put("room_id", item.getRoom_id());
                    params.put("token",(String)SharePrefsUtils.get(UserMainActivity.this,"user","token",""));
                    params.put("room_password",value);
                    Api.checkPass(UserMainActivity.this, params, new OnRequestDataListener() {
                        @Override
                        public void requestSuccess(int code, JSONObject data) {
            ...
            DialogEnsureUtiles.showConfirm(this, "该房间每分钟收费" + item.getMinute_charge(), new OnCustomClickListener() {
                @Override
                public void onClick(String value) {
                    MyApplication app = (MyApplication) getApplication();
