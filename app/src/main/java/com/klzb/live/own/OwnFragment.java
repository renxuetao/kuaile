...
import com.klzb.live.search.SearchActivity;
...
import com.klzb.live.own.family.FamilyActivity;
import com.klzb.live.own.fans.FansActivity;
import com.klzb.live.own.follow.FollowActivity;
import com.klzb.live.own.goexchange.GoExchangeActivity;
import com.klzb.live.own.level.MyLevelActivity;
import com.klzb.live.own.money.ChargeMoneyActivity;
import com.klzb.live.own.publishrecord.PublishRecordActivity;
import com.klzb.live.own.setting.SettingActivity;
import com.klzb.live.own.userinfo.ContributionActivity;
import com.klzb.live.own.userinfo.MyDataActivity;
 ...
 */
public class OwnFragment extends BaseFragment implements OnShareStatusListener ,View.OnClickListener {
...
//                    mTextUserLevelLv.setText(userInfo.getString("user_level"));
                        ...
                        FunctionUtile.setLevel(getContext(),mTextUserLevel,level);
//                        if(level<5){
