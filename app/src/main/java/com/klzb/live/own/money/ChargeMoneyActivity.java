package com.klzb.live.own.money;
...
import com.klzb.live.pay.alipay.Alipay;
import com.klzb.live.pay.alipay.PayResult;
import com.klzb.live.pay.wechat.Wechat;
...
//        });
    ...
    private void addWeChat(){
        ...
        // 将文本内容放到系统剪贴板里。
        cm.setText("ye0391");
        DialogEnsureUtiles.showConfirm(this, "联系微信ye0391充值(微信号已复制到剪贴板)", new OnCustomClickListener() {
            @Override
