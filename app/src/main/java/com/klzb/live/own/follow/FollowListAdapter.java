package com.klzb.live.own.follow;
...
//        }
        ...
        if("1".equals(item.getAttention())){
            holder.mFollowBtnCancel.setText("取消关注");
            holder.mFollowBtnCancel.setTextColor(mContext.getResources().getColor(R.color.colorGrayFont));
            holder.mImageAddAttention.setVisibility(View.GONE);
        }else{
            holder.mFollowBtnCancel.setText("关注");
