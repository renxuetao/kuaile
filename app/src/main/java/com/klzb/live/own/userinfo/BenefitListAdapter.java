 ...
 */
public class BenefitListAdapter extends RecyclerView.Adapter<BenefitListAdapter.ContributionViewHolder> {

    private Context mContext;
    private ArrayList<ContributionItem> mContributionItems;
    private OnRecyclerViewItemClickListener mOnRecyclerViewItemClickListener;
    public BenefitListAdapter(Context mContext, ArrayList<ContributionItem> mContributionItems) {
    ...
    public ContributionViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_benefit_list, parent, false);
