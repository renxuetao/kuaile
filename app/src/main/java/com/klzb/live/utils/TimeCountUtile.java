 ...
 * Author: XuDeLong
 */
public class TimeCountUtile extends CountDownTimer {
    ...
    public TimeCountUtile( Activity mActivity,long millisInFuture, long countDownInterval,Button btn) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        //设置按钮为灰色，这时是不能点击的
        //btn.setBackgroundColor(mActivity.getResources().getColor(R.color.cover_background));
    ...
    public void onFinish() {
        ...
        //btn.setBackground(mActivity.getResources().getDrawable(R.drawable.icon_btn));//还原背景色
